...
const Footer = () => {
    ...
    return (
      ...
      <div className="flex-1 flex flex-col flex-wrap p-2 ml-8">
        <h1 className="text-[25px]">WE ARE SS7</h1>
        <p>
      ...
      <div className="flex-1 flex flex-col p-2">
        <div className="flex m-3">
            ...
            <p className='pl-3'>State of Bangladesh</p>
        </div>
        <div className="flex m-3">
        ...
        <div className="flex m-3">
            ...
            <p className='pl-3'>fahimrimon21@gmail.com</p>
        </div>
      </div>
    </div>
    );
