    ...
    <div className="navbar h-[60px] shadow-md relative z-10 ">
      <div className="wrapper lg:pl-[20px] lg:pr-[20px] pt-[10px] pb-[10px] flex justify-between items-center pl-2 pr-2">
        ...
        <div className="left flex flex-1 ">
          <div className="logo font-bold text-xl mobile:text-sm">Dress Wear</div>
        </div>

        <div className=" center flex flex-1 text-center mobile:ml-6 justify-center items-center">
