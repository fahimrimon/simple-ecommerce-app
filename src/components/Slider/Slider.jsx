...
import { ApiSlides } from "../../apiComponents/SliderApi";
import "./Slider.css";
const Slider = () => {
  // Styles
  const slideStyle = "slide flex items-center justify-center h-[100%]";
  const arrowStyle = "rounded-full bg-gray-200 flex justify-center items-center shadow-md hover:cursor-pointer";
