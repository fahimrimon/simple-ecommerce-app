      ...
      <div className="flex justify-center mobile:flex-col mobile:mt-4 mobile:p-3">
        ...
        <div className="flex-[1.3] flex flex-col items-start  justify-items-center mt-10 mobile:items-center">
          ...
          <p className="disription pr-[4rem] text-justify mt-4 mobile:pr-0">
            Lorem ipsum, dolor sit amet consectetur adipisicing elit. Laudantium accusamus, culpa neque ex sunt placeat. Vitae
            quia qui quo, doloribus dolore aliquam veniam. Natus totam odit consequatur consectetur delectus nihil!
          </p>
          ...
          <button className="text-white bg-[#8a4af3] rounded-md shadow-md mt-[30px] p-3 hover:bg-blue-400 hover:text-black hover:scale-[1.1] ease-in duration-100">Add to Cart</button>
        </div>
      </div>
      <NewsLetter />
      <Footer />
